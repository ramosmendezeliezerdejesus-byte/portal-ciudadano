    ...
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <>
          ...
          <div className="fixed right-0 top-0 z-[200] h-full w-[88vw] max-w-sm card-soft border-l border-brand-teal/15 shadow-2xl slide-in md:absolute md:right-0 md:top-12 md:h-auto md:w-72 md:max-w-none md:rounded-2xl md:border md:border-brand-teal/15">
            <div className="flex h-full flex-col overflow-hidden md:max-h-[80vh]">
              <div className="flex items-center justify-between border-b border-brand-teal/10 px-4 py-4 md:hidden">
                <div>
              ...
              <div className="p-2 border-t border-brand-teal/10">
                <button
                  onClick={toggleDark}
